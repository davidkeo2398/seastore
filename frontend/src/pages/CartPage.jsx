      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">{getTotalItems()} sản phẩm trong giỏ hàng</p>
          </div>
                        ...
                        <div className="text-right">
                          ...
                          {item.oldPrice && (
                            <p className="text-sm text-green-600">
                              Tiết kiệm {formatPrice((item.oldPrice - item.price) * item.quantity)}
                            </p>
                          )}
                        </div>
                      </div>
            ...
            <Card className="sticky top-4">
              <CardContent className="p-6">
                ...
                {cartItems.some((item) => !item.inStock) && (
                  <p className="text-sm text-red-600 mt-2 text-center">Vui lòng xóa sản phẩm hết hàng để tiếp tục</p>
                )}
